...
<?php $this->renderMsgs(); ?>
<form action="m_msg.php" method="POST" class="step<?php echo $this->getData('step'); ?>">
...
<div class="center"><?php echo ILang::_('MsgSent'); ?> ~ [ <a href="./msgs.php" data-load="cache"><?php echo ILang::_('Back'); ?></a> ]</div>
<?php else : ?>
<div class="contenant">
	<div>
