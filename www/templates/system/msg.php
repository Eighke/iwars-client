			...
			<div class="outer">
				<div class="inner">
					...
					<div class="main">
						...
						<?php $this->renderMsgs(); ?>
						<div class="center">
							<div>[ <a href="./m_msg.php"><?php echo ILang::_('WriteMsg'); ?></a> ] [ <a href="./m_folder.php"><?php echo ILang::_('CreateFolder'); ?></a> ] | [ <a href="./msgs.php?a=1"><?php echo ILang::_('Archives'); ?></a> ]</div><br />
						...
						<form action="msgs.php" method="POST">
							<div id="msgDesc" class="div_content one_two">
								...
								<div id="msg">
									<div>De : <span id="msg_name" style="font-weight: bold;"><?php echo empty($this->getData('msg')->usrName) ? 'AutoMessage' : qftext($this->getData('msg')->usrName); ?></span> le <span id="msg_date"><?php echo fdate($this->getData('msg')->date, 1); ?></span> - <span><a<?php if ($this->getData('msg')->usrName) : ?> href="m_msg.php?id=<?php echo $this->getData('msg')->usrId; ?>"<?php endif; ?>><?php echo ILang::_('Reply'); ?></a></span></div>
									<div>Titre : <span id="msg_title" style="font-weight: bold;"><?php echo qftext($this->getData('msg')->title); ?></span></div><br />
									<div id="msg_text"><?php echo ftext($this->getData('msg')->text); ?></div><br />
									<div class="center">
										<input type="hidden" value="<?php echo $this->getData('msg')->id; ?>" name="id" />
										<input type="submit" value="<?php echo ILang::_('Reply'); ?>" name="rep" /> |
								...
								<div>
									...
									<div class="f_checkbox">
										...
										<div>
											...
											<span><?php if ($msg->archived == 'Y') : ?> [A] <?php endif; ?><a onClick="IWMsg.view(<?php echo $msg->id; ?>);" class="read_<?php echo $msg->read; ?>" href="?info=<?php echo $msg->id.$this->getData('query'); ?>"><?php echo ftext($msg->title); ?></a></span>
										</div>
										<?php endforeach; ?>
										<div class="clr"></div>
									</div><br />
