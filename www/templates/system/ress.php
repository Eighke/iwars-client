...
<table class="table table-striped">
	...
	<tbody>
		<tr>
			...
			<td><?php echo ILang::number($this->getData('prod')->r1->factQtt); ?> <span class="badge"><?php echo $this->getData('prod')->r1->stock; ?>%</span></td>
		...
		<tr>
			...
			<td><?php echo ILang::number($this->getData('prod')->r2->factQtt); ?> <span class="badge"><?php echo $this->getData('prod')->r2->stock; ?>%</span></td>
		...
		<tr>
			...
			<td><?php echo ILang::number($this->getData('prod')->r4->factQtt); ?> <span class="badge"><?php echo $this->getData('prod')->r4->stock; ?>%</span></td>
		...
		<tr>
			...
			<td><?php echo ILang::number($this->getData('prod')->r3->factQtt); ?> <span class="badge"><?php echo $this->getData('prod')->r3->stock; ?>%</span></td>
