						...
						<form action="move.php" method="post">
							<div id="units" class="block">
								...
								<div class="fields">
									...
									<div class="field">
										<a href="#" onClick="IWMove.select(<?php echo $id; ?>, <?php echo $nb; ?>)"><?php echo ILang::_('All'); ?></a> <input type="text" name="unit[<?php echo $id; ?>]" id="unit_<?php echo $id; ?>" value="<?php echo $this->getData('post')->unit[$id]; ?>" size="6" />
									</div>
								</div>
								<?php endforeach; ?>
								<div class="clr"></div>
							...
							<div id="resources">
								...
								<div class="block">
									<div class="fields">
										...
										<div class="field">
											<input type="text" name="R1" id="field-R1" value="<?php echo $this->getData('R1'); ?>" class="required" />
										</div>
									</div>
									<div class="fields">
										<div class="label">
										...
										<div class="field">
											<input type="text" name="R2" id="field-R2" value="<?php echo $this->getData('R2'); ?>" class="required" />
										</div>
									</div>
									<div class="fields">
										<div class="label">
									...
									<div class="fields">
										...
										<div class="field">
											<input type="text" name="R3" id="field-R3" value="<?php echo $this->getData('R3'); ?>" class="required" />
										</div>
									</div>
								</div>
							</div>
