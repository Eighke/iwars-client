		...
		<div>
			...
			<div class="f_checkbox">
				...
				<div>
					...
					<span><?php if ($msg->archived == 'Y') : ?> [A] <?php endif; ?><a data-id="<?php echo $msg->id; ?>" class="message read_<?php echo $msg->read; ?>" href="msgs.php?info=<?php echo $msg->id; ?>"><?php echo ftext($msg->title); ?></a></span>
				</div>
				<?php endforeach; ?>
				<div class="clr"></div>
			</div><br />
			...
			<div class="center">
				...
				<a href="msgs.php?page=1" data-load="cache"><<</a> <a href="msgs.php?page=<?php echo ($this->getData('page') - 1); ?>" data-load="cache"><</a>
				<?php endif; ?>
				<?php if ($this->getData('page') == 1) : ?>
					1
					<?php if ($this->getData('pageMax') > 1) : ?>
					<a href="msgs.php?page=2" data-load="cache">2</a>
					<?php endif; ?>
					<?php if ($this->getData('pageMax') > 2) : ?>
					<a href="msgs.php?page=3" data-load="cache">3</a>
					<?php endif; ?>
				<?php elseif ($this->getData('page') != $this->getData('pageMax')) : ?>
				<a href="msgs.php?page=<?php echo ($this->getData('page') - 1); ?>" data-load="cache"><?php echo ($this->getData('page') - 1); ?></a> <?php echo $this->getData('page'); ?> <a href="msgs.php?page=<?php echo ($this->getData('page') + 1); ?>" data-load="cache"><?php echo ($this->getData('page') + 1); ?></a>
				<?php else : ?>
					<a href="msgs.php?page=<?php echo ($this->getData('pageMax') - 2); ?>" data-load="cache">
					<?php if ($this->getData('pageMax') > 2) : ?>
						<?php echo ($this->getData('pageMax') - 2); ?></a>
					<?php endif; ?>
					<a href="msgs.php?page=<?php echo ($this->getData('pageMax') - 1); ?>" data-load="cache"><?php echo ($this->getData('pageMax') - 1); ?></a> <?php echo $this->getData('pageMax'); ?>
				<?php endif; ?>
				<?php if ($this->getData('page') != $this->getData('pageMax')) : ?>
				<a href="msgs.php?page=<?php echo ($this->getData('page') + 1); ?>" data-load="cache">></a> <a href="msgs.php?page=<?php echo $this->getData('pageMax'); ?>" data-load="cache">>></a>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			<?php else : ?>
