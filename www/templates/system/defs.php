	...
	<div class="one_two div_content">
		<div style="margin-<?php echo ++$j%2 == 0 ? 'right' : 'left' ; ?>:5px;">
			<span class="item" style="float:left; width:230px; margin:0 0 2px 0;">
				<b><a class="nolink" href="def.php?id=<?php echo $item->id; ?>" data-load="cache"><?php echo ILang::unit($item->id, 'name'); ?></a></b> (<?php echo ILang::_('Total'); ?> <?php echo ILang::number($this->town->getUnit($item->id)); ?>)<br />
